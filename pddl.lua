...
function readspec()
   local domain_file = assert(io.open("Praktikum_4/blocksworld.pddl", "r"))
   local problem_file = assert(io.open("Praktikum_4/pb3.pddl", "r"))
...
function readspecs( domain, problem )
   
   local domain_file = assert(io.open( domain, "r"))
   local problem_file = assert(io.open( problem, "r"))
